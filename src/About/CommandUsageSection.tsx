...
export const CommandUsageSection = () => {
  return (
    ...
    >
      <div class="section-heading space-y-3">
        <p
          class="eyebrow font-mono text-[0.68rem] font-bold uppercase
            tracking-[0.32em] text-violet-200"
        >
          Commands
        </p>
        <h2
      ...
      <pre
        class="command-examples mt-5 max-w-full overflow-x-auto
          whitespace-pre-wrap rounded-[1.5rem] border border-violet-200/20
          bg-black/45 p-5 text-sm leading-7 text-violet-100 shadow-inner
          shadow-black/40"
      >
        <code
          class="font-mono whitespace-pre-wrap break-words text-[0.82rem]
            leading-7 text-violet-100 sm:text-sm"
        >
          {commands.join('\n')}
        </code>
      </pre>
