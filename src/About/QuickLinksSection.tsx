    ...
    >
      ...
      <div class="quick-links mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {links.map(([label, href]) => (
          <a
            class="rounded-full border border-white/10 bg-white/[0.08] px-5 py-4
              text-center font-mono text-xs font-black uppercase
              tracking-[0.18em] text-[#fff7df] transition hover:-translate-y-0.5
              hover:border-amber-200/40 hover:bg-amber-200/10 focus:outline-none
              focus-visible:ring-4 focus-visible:ring-teal-300/45"
            href={href}
            key={href}
          >
            {label}
